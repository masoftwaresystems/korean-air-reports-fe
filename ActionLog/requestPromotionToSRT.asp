...
email_subject		= "Request to escalate to iSRT - "& viewDivision & logNumber

email_body2 = "<br><br><b>Request to escalate to iSRT for: </b><br>"& viewDivision & logNumber &"<br><br><b>Requested By: </b><br>"& session("first_name") &" "& session("last_name") &" ("& session("employee_number") &")"
