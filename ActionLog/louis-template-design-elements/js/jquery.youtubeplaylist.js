...
jQuery.fn.ytplaylist = function(options) {
  ...
  return this.each(function() {
		...
		function play(id)
		{
		   ...
		   html += 'type="application/x-shockwave-flash" wmode="transparent"  height="'+options.playerHeight+'" width="'+options.playerWidth+'"/>';
		   html += '</object>';
...
debugger;
var html = play(youtubeid($(this).attr("href")));
				$("#"+options.holderId+"").innerHTML=html;				$(this).parent().parent("ul").find("li.currentvideo").removeClass("currentvideo");
