...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="<%= tablebordercolor %>" width="<%= tablewidth %>">
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= headerheight %>">
    <td align="center" valign="middle"><span style="color:white;font-weight:bold;">A</span>
    </td>
    <td align="center" valign="middle"><span style="color:white;font-weight:bold;">B</span>
    </td>
    <td align="center" valign="middle"><span style="color:white;font-weight:bold;">C</span>
    </td>
    <td align="center" valign="middle"><span style="color:white;font-weight:bold;">D</span>
    </td>
    <td align="center" valign="middle"><span style="color:white;font-weight:bold;">E</span>
    </td>
  </tr>
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= labelheight %>" align="center" valign="bottom">
    ...
    <td width="<%= cellwidth %>" title="It will be excluded if the injuries were a result of natural causes, self-inflicted or inflicted by other persons."><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Physical Injury</span>
    </td>
    ...
    <td id="CELL_D_D" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Reported More Than Three Times Per Year Within The Company')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Reported More Than Three Times Per Year Within The Company</span>
    </td>
    <td id="CELL_E_E" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Reported More Than Three Times Per Year At A Particular Location')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Reported More Than Three Times Per Year At A Particular Location</span>
    </td>
  </tr>
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>" title="Negligible"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Negligible</span>
    </td>
    <td id="CELL_0_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Injury')" title="No injury"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">No Injury</span>
    </td>
    <td id="CELL_0_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Effect')" title="Zero damage"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">No Damage</span>
    </td>
    <td id="CELL_0_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Damage')" title="No increased cost or lost revenue"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">No Increased Cost Or Lost Revenue</span>
    </td>
    <td id="CELL_0_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Increased Cost or Lost Revenue')" title="No threat to personnel"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">No Threat To Personnel</span>
    </td>
    <td id="CELL_0_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Implication')" title="No issuance of administrative fines or administrative directives"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">No Implication</span>
    </td>
    <td id="CELL_0_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Implication')" title="No environmental damage or limited damage to minimum area of low significance"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Minimal Effect</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>" title="Minor"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Minor</span>
    </td>
    <td id="CELL_1_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Injury')" title="Minor injury (Less than a 'Serious injury')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Minor Injury</span>
    </td>
    <td id="CELL_1_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Effect')" title="Damage cost less than $10,000 and not affecting airworthiness"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Minor Damage (Less Than $10,000)</span>
    </td>
    <td id="CELL_1_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Damage &lt;US $50K')" title="Potential increased cost or lost revenue less than $10,000"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Minor Loss (Less Than $10,000)</span>
    </td>
    <td id="CELL_1_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Loss &lt;US $50K')" title="A threat assessed as non-credible with no immediate action required. (Unlikely threat)"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Unlikely Threat To Personnel</span>
    </td>
    <td id="CELL_1_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Limited Localized Implication')" title="Administrative directives issued without an issuance of administrative fine"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Administrative Directives Without Administrative Fines</span>
    </td>
    <td id="CELL_1_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Limited Localized Implication')" title="Small scale impacts on biological or physical environment and reversible within 1 year"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Minor Effect (Reversible Within 1 Year)</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>" title="Substantial"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Substantial</span>
    </td>
    <td id="CELL_2_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Serious Injury')" title="Multiple minor injuries"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Multiple Minor Injuries</span>
    </td>
    <td id="CELL_2_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Contained Effect')" title="Damage cost from $10,000 to less than $100,000 or affecting airworthiness"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Substantial Damage (From $10,000 To Less Than $100,000)</span>
    </td>
    <td id="CELL_2_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Substantial Damage &lt;US $250K')" title="Potential increased cost or lost revenue from $10,000 to less than $100,000"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Substantial Loss (From $10,000 To Less Than $100,000)</span>
    </td>
    <td id="CELL_2_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Substantial Loss &lt;US $250K')" title="A threat of doubtful credibility, but where it is prudent to consider taking additional protective measures. (Possible threat)"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Possible Threat To Personnel</span>
    </td>
    <td id="CELL_2_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Regional Implication')" title="Total amount of administrative fines range from USD 5,000 to less than USD 50,000"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Administrative Fines (From $5,000 To Less Than $50,000)</span>
    </td>
    <td id="CELL_2_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Regional Implication')" title="Medium scale impacts on biological or physical environment and reversible from 1 year to less than 2 years"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Substantial Effect (Reversible From 1 Year To Less Than 2 Years</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>" title="Major"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Major</span>
    </td>
    <td id="CELL_3_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Single Fatality')" title="Serious injury defines any injury which:&#13;&#13;&#183; Requires hospitalization for more than 48 hours, commencing within 7 days from the date the injury was received.&#13;&#183; Results in a fracture of any bone (except simple fractures of fingers, toes, or nose).&#13;&#183; Causes severe hemorrhages or nerve, muscle, or tendon damage.&#13;&#183; Involves any internal organ.&#13;&#183; Involves second, or third-degree burns, or any burns affecting more than 5% of the body surface."><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Serious Injury</span>
    </td>
    <td id="CELL_3_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Effect')" title="Damage cost from $100,000 to less than $10 million and affecting airworthiness"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Major Damage (From $100,000 To Less Than $10 Million)</span>
    </td>
    <td id="CELL_3_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Major Damage &lt;US $1M')" title="Potential increased cost or lost revenue from $100,000 to less than $10 million"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Major Loss (From $100,000 To Less Than  $10 Million)</span>
    </td>
    <td id="CELL_3_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Major Loss &lt;US $1M')" title="A credible and specific threat requiring immediate protective measures. (Probable threat)"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Probable Threat To Personnel</span>
    </td>
    <td id="CELL_3_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'National Implication')" title="Total amount of administrative fines range from USD 50,000 to less than USD 500,000"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Administrative Fines (From $50,000 To Less Than $500,000)</span>
    </td>
    <td id="CELL_3_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'National Implication')" title="Large scale impacts on biological or physical environment and reversible from 2 year to less than 5 years"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Major Effect (Reversible From 2 Years To Less Than 5 Years)</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>" title="Catastrophic"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Catastrophic</span>
    </td>
    <td id="CELL_4_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Multiple Fatalities')" title="One or more fatalities"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">One Or More Fatalities</span>
    </td>
    <td id="CELL_4_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Massive Effect')" title="Damage cost from $10 million or more and affecting airworthiness"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Catastrophic Damage (From $10 Million Or More)</span>
    </td>
    <td id="CELL_4_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Catastrophic Damage &ge;US $1M')" title="Potential increased cost or lost revenue from $10 million or more"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Catastrophic Loss (From $10 Million Or More)</span>
    </td>
    <td id="CELL_4_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Massive Loss &ge;US $1M')" title="Personnel are exposed to harm. (Imminent threat)"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Imminent Threat To Personnel</span>
    </td>
    <td id="CELL_4_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'International Implication')" title="AOC suspended or revoked by State because the OCA (Office of Civil Aviation), MLTM has determined that KE is not in a position to comply with the requirements OR amount of penalty exceeds USD 500,000."><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Suspension/ Revocation of AOC Or Administrative Fines (From $500,000 Or More)</span>
    </td>
    <td id="CELL_4_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'International Implication')" title="Irreversible and massive scale impacts on biological or physical environment"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Irreversible Effects</span>
    </td>
