...
<title></title><script language="JavaScript">
                                           ...
                                           <% else %>
                                           document.location = "divisionalDisplay.asp?overflow=y&searchVal=<%= searchVal %>&filterSelect=<%= filterSelect %>&divisionSelect=<%= divisionSelect %>";
                                           <% end if %>
                                           }
                                           function printPage2() {
                                           <% if(overflow = "y") then %>
                                           ...
                                           <% else %>
                                           window.open ("divisionalDisplay.asp?overflow=y&searchVal=<%= searchVal %>&filterSelect=<%= filterSelect %>&divisionSelect=<%= divisionSelect %>","printwindow");
                                           <% end if %>
                                           }
                                           <% if(overflow = "y") then %>
                                           printPage2();
                                           ...
                                           function switchView() {
                                             if(overflow != "y") {
                                               ...
                                               document.location = "divisionalDisplay.asp?searchVal=<%= searchVal %>&filterSelect=<%= filterSelect %>&divisionSelect=<%= divisionSelect %>";
                                             }
                                           }
                                </script>
                                <style>
...
function doSearch() {
  document.location = "divisionalDisplay.asp?searchVal="+ document.getElementById("searchVal").value +"&filterSelect=<%= filterSelect %>&divisionSelect=<%= divisionSelect %>&overflow=<%= overflow %>";
}

function doFilter() {
  document.location = "divisionalDisplay.asp?searchVal=<%= searchVal %>&filterSelect="+ document.getElementById("filterSelect").value +"&divisionSelect=<%= divisionSelect %>&overflow=<%= overflow %>";
}

function doDivision() {
  document.location = "divisionalDisplay.asp?searchVal=<%= searchVal %>&filterSelect=<%= filterSelect %>&divisionSelect="+ document.getElementById("divisionSelect").value +"&overflow=<%= overflow %>";
}
...
<input type="button" value="Refresh Locks" onclick="window.location.reload(true);" style="width:120px;font:bold 11px verdana;color:black;background-color:#FFFFFF;" />
	...
	<div id="advancedSearchDIV" bgcolor="#ffffff" align="left" style="padding-left:0px;display:none;">
	    <form method="post" action="divisionalDisplay.asp">
...
<form name="frm" id="frm" action="divisionalDisplay.asp" method="post">
...
<td style="FONT-WEIGHT: bold; FONT-SIZE: 8pt;COLOR: #ffffff; FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="000040" selected="true" colSpan="1" width="5%" align="center" vAlign="top">SRT</td>
...
<%
  ...
  srtlinksStr = ""
  sql = "select division, divisionalLogNumber from EHD_Data where srtLogNumber = "& sqlnum(srtlog_number) &" and active = 'y' and divisionalLogNumber is not null and formname = 'iSRT_LogInput' order by division asc, divisionalLogNumber asc"
...
<% end if %>
<%
isLocked = isLogLocked(log_number,viewDivision)
if(isLocked = "n") then
...
<span style="font-weight:bold;font-size:14px;"><%= viewDivision %><%= log_numberStr %>&nbsp;</span>
...
<td style="FONT-WEIGHT: normal; FONT-SIZE: 8pt;  FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="#ffffff" selected="false" colSpan="1"  vAlign="top" rowSpan="1" align="center">
<span style="font-weight:bold;"><%= srtlog_numberStr %><%= srtlinksStr %></span>
</td>
...
<td style="FONT-WEIGHT: normal; FONT-SIZE: 8pt;  FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="c0c0c0" selected="false" colSpan="1" align="center"  vAlign="top" rowSpan="1">
<span style="font-weight:bold;">POC Email</span>
</td>
<td style="FONT-WEIGHT: normal; FONT-SIZE: 8pt;  FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="c0c0c0" selected="false" colSpan="1" align="center" vAlign="top" rowSpan="1">
...
<tr><td style="FONT-WEIGHT: bold; FONT-SIZE: 12pt;  FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="ffffff" selected="false" rowSpan="1" colSpan="12" width="10%" align="right" vAlign="top" >
</td>
</tr>
<% end if %>
<%
...
<span style="font-weight:normal;"><%= viewDivision %><%= log_numberStr %>.<%= a %></span>
</td>
<td style="FONT-WEIGHT: normal; FONT-SIZE: 8pt;  FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="ffffff" selected="false" colSpan="1" vAlign="top" rowSpan="1">
...
<span style="font-weight:normal;"><%= safety_action_poc_email %></span>
</td>
<td style="FONT-WEIGHT: normal; FONT-SIZE: 8pt;  FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="ffffff" selected="false" colSpan="1"  align="center" vAlign="top" rowSpan="1">
...
<tr><td style="FONT-WEIGHT: bold; FONT-SIZE: 12pt;  FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="ffffff" selected="false" rowSpan="1" colSpan="12" align="right" vAlign="top" ><br>
</td>
</tr>
<tr><td style="height:0px;" bgcolor="#dcdcdf" colspan="12"></td></tr>
<%
next
...
%>
<tr><td style="height:8px;FONT-WEIGHT: normal; FONT-SIZE: 8pt;  FONT-STYLE: normal; FONT-FAMILY: Arial;padding-left:5px;" bgcolor="#ffffff" colspan="11" align="left"><% if(acnt > 0) then
...
<%
sql = "select * from SRT_Links where primary_log_number = "& sqlnum(srtlog_number) &" and archived = 'n'"
...
<tr><td style="height:0px;" bgcolor="#ffffff" colspan="12"></td></tr>
<%
...
<tr height="0">
<td align="center">
<span style="width:150px;font-weight:bold;"><% if(startpos > 0) then %><a href="divisionalDisplay.asp?position=<%= prevpos %>&filterSelect=<%= filterSelect %>&searchVal=<%= searchVal %>&divisionSelect=<%= divisionSelect %>">&lt;&lt;prev</a><% else %>&lt;&lt;prev<% end if %></span>
<span style="width:150px;font-weight:bold;"><% if(recsshown = 11) then %><a href="divisionalDisplay.asp?position=<%= currpos %>&filterSelect=<%= filterSelect %>&searchVal=<%= searchVal %>&divisionSelect=<%= divisionSelect %>">next&gt;&gt;</a><% else %>next&gt;&gt;<% end if %></span>
</td>
</tr>
