...
<html><head>
<title>Bristow SMAL Overdue Report 2</title>
<style>
@media print{
...
<table border="0" cellpadding="0" cellspacing="0" width="850" align="center">
	<tr>
		<td height="80" background2="http://www.bristowgroup.com/images/body_mid.gif" bgcolor="#EFEBE7" align="center">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td width="50%" style="padding-left:30px;" ><a href="http://www.bristowgroup.com"><img width="146" height="40" src="http://www.bristowgroup.com/images/bristow_logo.gif" alt="Bristow" border="0" /></a></td>
...
sql = "select lognumber, division from EHD_Data where active = 'y' and archived = 'n' and formname = 'iSRT_LogInput' and (("& baseStr &") and ("& divisionStr &") "& hazardtypesStr &") and divisionalLogNumber is not null order by division asc, lognumber asc"
...
daysStr = clng(daysStr) * -1
lateStr = lateStr &"<div style='padding-bottom:3px;width:300px;text-align:left;'><a href='#"& viewDivision & log_numberStr &"'>&middot;&nbsp;"& hazard_id &" - "& daysStr &" days late</a></div>"
...
<tr valign="top" style="padding-top:3px;">
  <td colspan="2" align="center" style="padding-right:5px;"><div style='padding-bottom:10px;width:300px;text-align:left;'><span style="font-weight:normal;color:black;">Total Late Hazards :</span><span style="font-weight:bold;"><%= total_hazards %></span></div><%= lateStr %></td>
</tr>
</table>

<%
sql = "select lognumber, division from EHD_Data where active = 'y' and archived = 'n' and formname = 'iSRT_LogInput' and (("& baseStr &") and ("& divisionStr &") "& hazardtypesStr &") and divisionalLogNumber is not null order by division asc, base asc, hazard_type asc, hazard_number asc"
...
%>
<a name="<%= viewDivision %><%= log_numberStr %>"></a>
<table cellspacing="0" cellpadding="0" width="100%" border="0">
<tr valign="top" style="padding-top:3px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;"></span></td>
  <td width="<%= cell2width %>"><div style="font-size:10px;">[ <a href="#TOP">back to top</a> ]</div></td>
</tr>
<tr valign="top" style="padding-top:3px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= rev_xdata2(item_comments) %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Base :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= base %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Aircraft :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= equipment %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= hazard_editor %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= endorsed %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Endorsed By :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= endorsed_by %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Next Review Date :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= next_review_dateStr %></span></td>
</tr>
<!--
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Initial Assessment Date :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= initial_assessment_date %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Initial Assessment Occasion :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= initial_assessment_occasion %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Current Assessment Date :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= current_assessment_date %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Current Assessment Occasion :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= current_assessment_occasion %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Post Assessment Date :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= post_assessment_date %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Post Assessment Occasion :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= post_assessment_occasion %></span></td>
</tr>
-->
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Futher Risk Reduction Needed? :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= further_risk_reduction_needed %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Hazard Ok?/ALARP :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= hazard_ok_alarp %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">ALARP Statement :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= rev_xdata2(alarp_statement) %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"current_measures_responsible_person","") %></div></td>
</tr>
<%
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><div style="font-weight:bold; COLOR: <%= tmpcolor %>;"><%= selectNode(oXML,"risk_value_pre_mitigation","") %></div></td>
</tr>
...
<tr valign="top" style="padding-top:7px;">
  ...
  <table width="300" cellpadding="0" cellspacing="1" border="0" bgcolor="black">
    <tr>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;">Likelihood</span></td>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;">Severity</span></td>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;">Risk Level</span></td>
    </tr>
    <tr>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= selectNode(oXML,"pre_likelihood_level","") %></span></td>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= tmpSeverity %></span></td>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= tmpRiskLevel %></span></td>
    </tr>
  </table>
  </td>
</tr>
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"pre_physical_injury","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Damage to the Environment :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"pre_damage_to_the_environment","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Damage to Assets :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"pre_damage_to_assets","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"pre_potential_increased_cost","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"pre_damage_to_corporate_reputation","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Likelihood :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"pre_likelihood","") %></div></td>
</tr>
-->
...
<div style="font-weight:normal;padding-bottom:6px;"><% if(selectNode(oXML,"corrective_action_item_"& a,"") <> "") then %><span style="width:75px;"><%= selectNode(oXML,"corrective_action_item_"& a,"") %> :: </span><% end if %><%= rev_xdata2(selectNode(oXML,"corrective_action_"& a,"")) %></div>
<% next %>
  </div></td>
</tr>
<!--
...
<tr valign="top" style="padding-top:7px;">
  ...
  <table width="300" cellpadding="0" cellspacing="1" border="0" bgcolor="black">
    ...
    <tr>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= selectNode(oXML,"post_likelihood_level","") %></span></td>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= tmpSeverity %></span></td>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= tmpRiskLevel %></span></td>
    </tr>
  </table>
...
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Physical Injury :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"post_physical_injury","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Damage to the Environment :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"post_damage_to_the_environment","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Damage to Assets :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"post_damage_to_assets","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Potential Increased Cost or Revenue Loss :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"post_potential_increased_cost","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Damage to Corporate Reputation :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"post_damage_to_corporate_reputation","") %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Likelihood :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"post_likelihood","") %></div></td>
</tr>
-->
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"></td>
