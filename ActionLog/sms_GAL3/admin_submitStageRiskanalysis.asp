...
'###############################################
'#
'# admin_submitStageRiskanalysis.asp
'#
...
<!--#include file ="includes/wrapFormData_SRTStage.inc"-->
<%
...
<table border="0" cellspacing="0" cellpadding="0" width="550" style="margin-top:15px;margin-left:10px;" bgColor="white" >
  <tr>
    <td width="100%" align="center">
      <input type="button" value="Return To Homepage" style="font-weight:bold;font-size:10px;background-color:white;width:160px;margin-top:5px;margin-left:0px;" onclick="document.location='splash.asp'"><br /><input type="button" value="Return To Stage List" style="font-weight:bold;font-size:10px;background-color:white;width:160px;margin-top:1px;margin-left:0px;" onclick="document.location='admin_StageList.asp?viewDivision=<%= viewDivision %>'"><br /><input type="button" value="Go To Action Log" style="font-weight:bold;font-size:10px;background-color:white;width:160px;margin-top:1px;margin-left:0px;" onclick="document.location='admin_LogDisplay.asp?viewDivision=<%= viewDivision %>'">
    </td>
  </tr>
  <tr>
