...
<html><head>
<title>KE Hazard Action Log Report</title>
<style>
@media print{
...
<body>
<div class="hideprint">
<a href="http://www.web2pdfconvert.com/convert.aspx">[<b> Save to PDF </b>]</a>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%;">
	<tr>
		<td align="center">
<h3>KE Safety Report<br>
Divisions&nbsp;::&nbsp;<%= replace(division,"'","") %>
<% if(request("risk") <> "") then %><br><%= request("risk") %><% end if %>
</h3>
<div id="PINWHEEL" style="display:none;"><img src="http://www.bristowsafety.com/images/pinwheel.gif"></div>
...
sql = "select lognumber, division from EHD_Data where active = 'y' and archived = 'n' and formname = 'iSRT_LogInput' and ("& divisionStr &") and divisionalLogNumber is not null order by lognumber asc"
...
<%
sql = "select lognumber, division from EHD_Data where active = 'y' and archived = 'n' and formname = 'iSRT_LogInput' and (("& divisionStr &")) and divisionalLogNumber is not null  order by division asc, lognumber asc"
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= next_review_date %></span></td>
</tr>
<!--
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= alarp_statement %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <table width="300" cellpadding="0" cellspacing="1" border="0" bgcolor="black">
    <tr>
      ...
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;">Risk Value</span></td>
    </tr>
    <tr>
      ...
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= transRisk(selectNode(oXML,"risk_value_pre_mitigation","")) %></span></td>
    </tr>
  </table>
  </td>
</tr>
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= rev_xdata2(selectNode(oXML,"unintended_consequences","")) %></div></td>
</tr>
-->
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <table width="300" cellpadding="0" cellspacing="1" border="0" bgcolor="black">
    ...
    <tr>
      ...
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= tmpRiskLevel %></span></td>
      <td width="33%" align="center" bgcolor="white"><span style="font-weight:normal;"><%= transRisk(selectNode(oXML,"risk_value_post_mitigation","")) %></span></td>
    </tr>
  </table>
  </td>
</tr>
