...
sql = "select * from EHD_Data where formname = 'iSRT_LogInput' and logNumber = "& sqlnum(log_number) &" and archived = 'n' and active = 'y' order by logNumber desc, recid desc"
...
<tbody>
<tr><td style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; COLOR: #ffffff; FONT-FAMILY: Arial" align="center" width="100%" background="" bgColor="000080" colSpan="4">Risk Assessment of Divisional Action Log Item</td>
</tr>
...
%>
<textarea name="contributing_factor_<%= a %>" style="width:540px;margin-left:10px;margin-top:5px;" rows="2"><%= rev_xdata2(selectNode(oXML,"contributing_factor_"& a,"")) %></textarea>
<%
next
%>
...
%>
<textarea name="active_error_<%= a %>" style="width:540px;margin-left:10px;margin-top:5px;" rows="2"><%= rev_xdata2(selectNode(oXML,"active_error_"& a,"")) %></textarea>
<%
next
%>
...
%>
<textarea name="latent_condition_<%= a %>" style="width:540px;margin-left:10px;margin-top:5px;" rows="2"><%= rev_xdata2(selectNode(oXML,"latent_condition_"& a,"")) %></textarea>
<%
next
%>
...
%>
<textarea name="causal_factor_<%= a %>" style="width:540px;margin-left:10px;margin-top:5px;" rows="2"><%= rev_xdata2(selectNode(oXML,"causal_factor_"& a,"")) %></textarea>
<%
next
%>
...
<table id="table1" cellSpacing="0" cellPadding="0" width="100%" border="0" style="display:none;padding-left:60px;">
...
<table id="table2" cellSpacing="0" cellPadding="0" width="100%" border="0" style="display:none;padding-left:60px;">
...
<tr >
<td align="center">
<input type="submit" value="Submit" style="font-weight:bold;font-size:10px;background-color:white;width:160px;margin-top:5px;margin-left:0px;"><input type="button" value="Return To Log Input" style="font-weight:bold;font-size:10px;background-color:white;width:165px;margin-top:5px;margin-left:0px;" onclick="document.location='divisional_LogInput.asp?log_number=<%= log_number %>&viewDivision=<%= viewDivision %>'"><br><input type="button" value="Return To Action Log" style="font-weight:bold;font-size:10px;background-color:white;width:165px;margin-top:1px;margin-left:0px;" onclick="document.location='divisional_LogDisplay.asp?viewDivision=<%= viewDivision %>'">
</td>
</tr>
