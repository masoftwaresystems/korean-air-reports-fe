...
<td style="FONT-WEIGHT: bold; FONT-SIZE: 8pt;COLOR: #ffffff; FONT-STYLE: normal; FONT-FAMILY: Arial" bgColor="000040" selected="true" colSpan="1" width="5%" align="center" vAlign="top">Cross-divisional<br>Log Nbr.</td>
...
if(isLocked = "n") then
  clickloc = "document.location='divisional_LogInput.asp?log_number="& log_number &"'"
else
