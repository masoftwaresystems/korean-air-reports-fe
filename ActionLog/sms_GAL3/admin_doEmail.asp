...
'# admin_doEmail.asp
'#
'# Sends email and attachments from the iSRT area
'#
%>
...
<%
'###############################################
'# Code structure to build and send email
'#
%>
<%
...
<table border="0" cellspacing="0" cellpadding="0" width="550" style="margin-top:15px;margin-left:10px;" bgColor="white" >
  <tr>
    <td width="100%" align="center">
      <input type="button" value="Return To Log Input" style="font-size:10px;font-size:10px;width:160px;margin-top:5px;margin-left:0px;" onclick="document.location='admin_LogInput.asp?log_number=<%= log_number %>'"><input type="button" value="Return To Action Log" style="font-size:10px;font-size:10px;width:160px;margin-top:1px;margin-left:0px;" onclick="document.location='admin_LogDisplay.asp'">
    </td>
  </tr>
  <tr>
