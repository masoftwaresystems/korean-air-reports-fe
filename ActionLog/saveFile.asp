...
response.write("log number X :"& request("log_number"))
response.end

set oUpload = server.createobject("ASPUpLoad.clsUpload")
oUpload.Path = Server.MapPath("./tmpfiles")
...
BinaryStream.LoadFromFile Server.MapPath("./tmpfiles/"&newfilename)
...
objFSO.DeleteFile Server.MapPath("./tmpfiles/"& newfilename)
