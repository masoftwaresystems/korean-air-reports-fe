...
<body >
<div id="page-box">
  <div id="logo"> <a href="splash.aspx"><img src="images/Korean-Air-logo.png" width="236" height="50" alt="SMAL" /></a></div>
<br class="clear">    
  <div id="topNav">
	<!--#include virtual="topNav.aspx" -->
    </div>
<div id="mainContent">
<uc:ContentDownloader id="Menu" runat="server" URL="/load_generic.asp"></uc:ContentDownloader>
</div>
<br class="clear">
<div id="footer">
