...
<% if(overflow <> "y") then %>
            <table cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="white">
              <td align="center">
                ...
                <% if(startpos > 0) then %>
                  <a href="divisional_LogDisplay.asp?position=<%= prevpos %>&filterSelect=<%= filterSelect %>&searchVal=<%= searchVal %>&divisionSelect=<%= divisionSelect %>&viewDivision=<%= viewDivision %>&searchType=<%= searchType %>">
                    &lt;&lt;prev
                  </a>
                <% else %>
                  &lt;&lt;prev
                ...
                <% if(recsshown = 11) then %>
                  <a href="divisional_LogDisplay.asp?position=<%= currpos %>&filterSelect=<%= filterSelect %>&searchVal=<%= searchVal %>&divisionSelect=<%= divisionSelect %>&viewDivision=<%= viewDivision %>&searchType=<%= searchType %>">
                    next&gt;&gt;
                  </a>
                <% else %>
                  next&gt;&gt;
