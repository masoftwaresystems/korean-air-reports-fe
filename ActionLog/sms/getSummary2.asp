...
<%
  ...
  if not rs4.eof then
    ...
    if(viewdivision <> "EH:DIV") then
      srtlinksStr = srtlinksStr &"<a href='admin_LogInput.aspx?log_number="& srtLogNumber &"&viewDivision=EH:DIV'>EH:DIV"& string(4-len(srtLogNumber),"0")&srtLogNumber &"</a><br>"
    end if
...
%>
<a href="admin_LogInput.aspx?log_number=<%= lrs("secondary_log_number") %>&viewDivision=<%= viewDivision %>"><%= tmp_division %><%= tmp_secondarylognumber %></a><br>
<%
  else
%>
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>" align="left"><span style="font-weight:normal;"><%= safety_action_poc_name %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
...
<%
pre_likelihood = ""
if(selectNode(oXML,"pre_likelihood","") = "Unknown But Possible In The Aviation Industry") then
  pre_likelihood = "A"
end if
if(selectNode(oXML,"pre_likelihood","") = "Known In The Avaition Industry") then
  pre_likelihood = "B"
end if
if(selectNode(oXML,"pre_likelihood","") = "Occurred In The Company") then
  pre_likelihood = "C"
end if
if(selectNode(oXML,"pre_likelihood","") = "Reported More Than Three Times Per Year Within The Company") then
  pre_likelihood = "D"
end if
if(selectNode(oXML,"pre_likelihood","") = "Reported More Than Three Times Per Year At A Particular Location") then
  pre_likelihood = "E"
end if
...
if(selectNode(oXML,"pre_physical_injury","") = "No Injury") then
  pre_physical_injury = "Negligible"
end if
if(selectNode(oXML,"pre_damage_to_the_environment","") = "No Effect") then
  pre_damage_to_the_environment = "Negligible"
end if
if(selectNode(oXML,"pre_damage_to_assets","") = "No Damage") then
  pre_damage_to_assets = "Negligible"
end if
if(selectNode(oXML,"pre_potential_increased_cost","") = "No Increased Cost or Lost Revenue") then
  pre_potential_increased_cost = "Negligible"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation","") = "No Implication") then
  pre_damage_to_corporate_reputation = "Negligible"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation2","") = "No Implication") then
  pre_damage_to_corporate_reputation2 = "Negligible"
end if

if(selectNode(oXML,"pre_physical_injury","") = "Minor Injury") then
  pre_physical_injury = "Minor"
end if
if(selectNode(oXML,"pre_damage_to_the_environment","") = "Minor Effect") then
  pre_damage_to_the_environment = "Minor"
end if
if(selectNode(oXML,"pre_damage_to_assets","") = "Minor Damage &lt;US $50K") then
  pre_damage_to_assets = "Minor"
end if
if(selectNode(oXML,"pre_potential_increased_cost","") = "Minor Loss &lt;US $50K") then
  pre_potential_increased_cost = "Minor"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation","") = "Limited Localized Implication") then
  pre_damage_to_corporate_reputation = "Minor"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation2","") = "Limited Localized Implication") then
  pre_damage_to_corporate_reputation2 = "Minor"
end if

if(selectNode(oXML,"pre_physical_injury","") = "Serious Injury") then
  pre_physical_injury = "Substantial"
end if
if(selectNode(oXML,"pre_damage_to_the_environment","") = "Contained Effect") then
  pre_damage_to_the_environment = "Substantial"
end if
if(selectNode(oXML,"pre_damage_to_assets","") = "Substantial Damage &lt;US $250K") then
  pre_damage_to_assets = "Substantial"
end if
if(selectNode(oXML,"pre_potential_increased_cost","") = "Substantial Loss &lt;US $250K") then
  pre_potential_increased_cost = "Substantial"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation","") = "Regional Implication") then
  pre_damage_to_corporate_reputation = "Substantial"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation2","") = "Regional Implication") then
  pre_damage_to_corporate_reputation2 = "Substantial"
end if

if(selectNode(oXML,"pre_physical_injury","") = "Single Fatality") then
  pre_physical_injury = "Major"
end if
if(selectNode(oXML,"pre_damage_to_the_environment","") = "Minor Effect") then
  pre_damage_to_the_environment = "Major"
end if
if(selectNode(oXML,"pre_damage_to_assets","") = "Major Damage &lt;US $1M") then
  pre_damage_to_assets = "Major"
end if
if(selectNode(oXML,"pre_potential_increased_cost","") = "Major Loss &lt;US $1M") then
  pre_potential_increased_cost = "Major"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation","") = "National Implication") then
  pre_damage_to_corporate_reputation = "Major"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation2","") = "National Implication") then
  pre_damage_to_corporate_reputation2 = "Major"
end if

if(selectNode(oXML,"pre_physical_injury","") = "Multiple Fatalities") then
  pre_physical_injury = "Catastrophic"
end if
if(selectNode(oXML,"pre_damage_to_the_environment","") = "Massive Effect") then
  pre_damage_to_the_environment = "Catastrophic"
end if
if(selectNode(oXML,"pre_damage_to_assets","") = "Catastrophic Damage &ge;US $1M") then
  pre_damage_to_assets = "Catastrophic"
end if
if(selectNode(oXML,"pre_potential_increased_cost","") = "Massive Loss &ge;US $1M") then
  pre_potential_increased_cost = "Catastrophic"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation","") = "International Implication") then
  pre_damage_to_corporate_reputation = "Catastrophic"
end if
if(selectNode(oXML,"pre_damage_to_corporate_reputation2","") = "International Implication") then
...
<tr valign="top" style="padding-top:7px;">
  ...
  <table width="200" cellpadding="0" cellspacing="1" border="0" bgcolor="black">
    <tr>
      ...
      <td width="50%" align="center" bgcolor="white"><span style="font-weight:normal;">Probability</span></td>
    </tr>
    <tr>
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= pre_physical_injury %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">A/C or Equipment Damage :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= pre_damage_to_the_environment %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
...
<div style="font-weight:normal;"><% if(selectNode(oXML,"corrective_action_item_"& a,"") <> "") then %><span style="width:75px;">(<%= selectNode(oXML,"corrective_action_item_"& a,"") %>)</span><% end if %><%= rev_xdata2(selectNode(oXML,"corrective_action_"& a,"")) %></div>
<% next %>
  </div></td>
</tr>
<!--
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"unintended_consequences","") %></div></td>
</tr>
-->
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Responsible Team :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= selectNode(oXML,"corrective_actions_responsible_person","") %></div></td>
</tr>
<%
...
<%
post_likelihood = ""
if(selectNode(oXML,"post_likelihood","") = "Unknown But Possible In The Aviation Industry") then
  post_likelihood = "A"
end if
if(selectNode(oXML,"post_likelihood","") = "Known In The Avaition Industry") then
  post_likelihood = "B"
end if
if(selectNode(oXML,"post_likelihood","") = "Occurred In The Company") then
  post_likelihood = "C"
end if
if(selectNode(oXML,"post_likelihood","") = "Reported More Than Three Times Per Year Within The Company") then
  post_likelihood = "D"
end if
if(selectNode(oXML,"post_likelihood","") = "Reported More Than Three Times Per Year At A Particular Location") then
  post_likelihood = "E"
end if
...
if(selectNode(oXML,"post_physical_injury","") = "No Injury") then
  post_physical_injury = "Negligible"
end if
if(selectNode(oXML,"post_damage_to_the_environment","") = "No Effect") then
  post_damage_to_the_environment = "Negligible"
end if
if(selectNode(oXML,"post_damage_to_assets","") = "No Damage") then
  post_damage_to_assets = "Negligible"
end if
if(selectNode(oXML,"post_potential_increased_cost","") = "No Increased Cost or Lost Revenue") then
  post_potential_increased_cost = "Negligible"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation","") = "No Implication") then
  post_damage_to_corporate_reputation = "Negligible"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation2","") = "No Implication") then
  post_damage_to_corporate_reputation2 = "Negligible"
end if

if(selectNode(oXML,"post_physical_injury","") = "Minor Injury") then
  post_physical_injury = "Minor"
end if
if(selectNode(oXML,"post_damage_to_the_environment","") = "Minor Effect") then
  post_damage_to_the_environment = "Minor"
end if
if(selectNode(oXML,"post_damage_to_assets","") = "Minor Damage &lt;US $50K") then
  post_damage_to_assets = "Minor"
end if
if(selectNode(oXML,"post_potential_increased_cost","") = "Minor Loss &lt;US $50K") then
  post_potential_increased_cost = "Minor"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation","") = "Limited Localized Implication") then
  post_damage_to_corporate_reputation = "Minor"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation2","") = "Limited Localized Implication") then
  post_damage_to_corporate_reputation2 = "Minor"
end if

if(selectNode(oXML,"post_physical_injury","") = "Serious Injury") then
  post_physical_injury = "Substantial"
end if
if(selectNode(oXML,"post_damage_to_the_environment","") = "Contained Effect") then
  post_damage_to_the_environment = "Substantial"
end if
if(selectNode(oXML,"post_damage_to_assets","") = "Substantial Damage &lt;US $250K") then
  post_damage_to_assets = "Substantial"
end if
if(selectNode(oXML,"post_potential_increased_cost","") = "Substantial Loss &lt;US $250K") then
  post_potential_increased_cost = "Substantial"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation","") = "Regional Implication") then
  post_damage_to_corporate_reputation = "Substantial"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation2","") = "Regional Implication") then
  post_damage_to_corporate_reputation2 = "Substantial"
end if

if(selectNode(oXML,"post_physical_injury","") = "Single Fatality") then
  post_physical_injury = "Major"
end if
if(selectNode(oXML,"post_damage_to_the_environment","") = "Minor Effect") then
  post_damage_to_the_environment = "Major"
end if
if(selectNode(oXML,"post_damage_to_assets","") = "Major Damage &lt;US $1M") then
  post_damage_to_assets = "Major"
end if
if(selectNode(oXML,"post_potential_increased_cost","") = "Major Loss &lt;US $1M") then
  post_potential_increased_cost = "Major"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation","") = "National Implication") then
  post_damage_to_corporate_reputation = "Major"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation2","") = "National Implication") then
  post_damage_to_corporate_reputation2 = "Major"
end if

if(selectNode(oXML,"post_physical_injury","") = "Multiple Fatalities") then
  post_physical_injury = "Catastrophic"
end if
if(selectNode(oXML,"post_damage_to_the_environment","") = "Massive Effect") then
  post_damage_to_the_environment = "Catastrophic"
end if
if(selectNode(oXML,"post_damage_to_assets","") = "Catastrophic Damage &ge;US $1M") then
  post_damage_to_assets = "Catastrophic"
end if
if(selectNode(oXML,"post_potential_increased_cost","") = "Massive Loss &ge;US $1M") then
  post_potential_increased_cost = "Catastrophic"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation","") = "International Implication") then
  post_damage_to_corporate_reputation = "Catastrophic"
end if
if(selectNode(oXML,"post_damage_to_corporate_reputation2","") = "International Implication") then
...
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Physical Injury :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= post_physical_injury %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">A/C or Equipment Damage :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= post_damage_to_the_environment %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Potential Increased Cost or Revenue Loss :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= post_damage_to_assets %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Security Threat :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= post_potential_increased_cost %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Regulatory Compliance :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= post_damage_to_corporate_reputation %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Damage to the Environment :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= post_damage_to_corporate_reputation2 %></div></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Probability Level :</span></td>
  <td width="<%= cell2width %>"><div style="font-weight:normal;"><%= URLDecode(selectNode(oXML,"post_likelihood","")) %></div></td>
</tr>
</table>
