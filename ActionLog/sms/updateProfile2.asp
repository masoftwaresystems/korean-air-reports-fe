...
<form id="frm" name="frm" action="do_updateProfile2.asp" method="post">
<input type="hidden" name="loginID" value="<%= request("loginID") %>">
<input type="hidden" name="user" value="<%= request("user") %>">
<input type="hidden" name="division" value="EHD-SAG">
...
<table border="0" cellspacing="5" cellpadding="0" width="550" style="padding-top:15px;margin-left:10px;">
  ...
  <tr>
    ...
    <td width="60%" align="left"><%= first_name %></td>
  </tr>
  <tr>
    <td width="40%" align="right"><span class="fonts1" style="font-size:14px; color:#737579;">Last Name :</span></td>
    <td width="60%" align="left"><%= last_name %></td>
  </tr>
  <tr>
    <td width="40%" align="right"><span class="fonts1" style="font-size:14px; color:#737579;">Business Unit :</span></td>
    <td width="60%" align="left"><%= business_unit %></td>
  </tr>
  <tr>
    <td width="40%" align="right"><span class="fonts1" style="font-size:14px; color:#737579;">Base :</span></td>
    <td width="60%" align="left"><%= base %></td>
  </tr>
  <tr>
    <td width="40%" align="right"><span class="fonts1" style="font-size:14px; color:#737579;">Email Address :</span></td>
    <td width="60%" align="left"><%= email_address %></td>
  </tr>
  <tr>
    <td width="40%" align="right"><span class="fonts1" style="font-size:14px; color:#737579;">Phone Number :</span></td>
    <td width="60%" align="left"><%= phone_number %></td>
  </tr>
</table>
