...
divisionStr = "BASE|base"   'Source
bu = "AUSBU Generic|AUSBU"  'Target
...
sql = "select * from EHD_Data where division = "& sqltext2(trim(tmpStr(0))) &" and formName = 'iSRT_LogInput' and active = 'y' and archived = 'n' and formDataXML is not null and formDataXML <> '' and hazard_number  in (31,39) order by logNumber asc"
