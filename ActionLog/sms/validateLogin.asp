...
sql = "select loginID, username, srt_admin, employee_number, first_name, nvl(last_name,'') last_name, employee_type, division, email_address, srt_passwordchange, business_unit, basic_admin admin, sms_admin, base from Tbl_Logins where employee_number = "& employee_number &" and pw = "& password
