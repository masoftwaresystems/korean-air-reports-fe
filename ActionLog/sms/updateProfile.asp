  ...
  <tr>
    ...
    <td width="60%" align="left">
            <select class="input6" name="employee_type" id="employee_type" style="width:200px;border:1px solid black;" required>
              <option value=""></option>
              <option value="DOY/GOY">DOY/GOY</option>
              <option value="Executive Level">Executive Level</option>
              <option value="OYP/OYI/OYE/OYS/OYA">OYP/OYI/OYE/OYS/OYA</option>
              <option value="Team Leader Level">Team Leader Level</option>
              <option value="Administrator Level">Administrator Level</option>
              <option value="SELOY">SELOY</option>
              <option value="General User Level">General User Level</option>
              <option value="Primary User Level">Primary User Level</option>
