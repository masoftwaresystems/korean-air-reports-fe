...
%>
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="white">
          ...
          <td align="center">
            ...
            <!--
            <input type="button" value="Return To Action Log" style="font-size:10px;width:160px;margin-top:1px;margin-left:0px;" onclick="document.location='divisional_LogDisplay.aspx?viewDivision=<%= viewDivision %>&position=<%= request("cookie_position") %>'">
            -->
          </td>
        </tr>
        <tr height="50">
