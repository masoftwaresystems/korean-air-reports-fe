...
sql = "select logNumber, division, recid, loginID, createDate, formdataXML from EHD_Data where formname = 'risk' and srtStageNumber = "& sqlnum(log_number) &" and archived = 'n' and active = 'y' and division = "& sqltext2(viewDivision) &" order by logNumber desc, recid desc"
...
<form name="frm" id="frm" method="post" action="divisional_submitStageRiskanalysis.asp">
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="<%= tablebordercolor %>" width="<%= tablewidth %>">
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    ...
    <td id="CELL_1_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Loss <US $50K')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Minor Loss &ltUS $50K</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    ...
    <td id="CELL_2_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Substantial Damage <US $250K')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Substantial Damage &ltUS $250K</span>
    </td>
    <td id="CELL_2_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Substantial Loss <US $250K')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Substantial Loss &ltUS $250K</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    ...
    <td id="CELL_3_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Major Damage <US $1M')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Major Damage &ltUS $1M</span>
    </td>
    <td id="CELL_3_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Major Loss <US $1M')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Major Loss &ltUS $1M</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    ...
    <td id="CELL_4_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Catastrophic Damage &#8805;US $1M')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Catastrophic Damage &#8805;US $1M</span>
    </td>
    <td id="CELL_4_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Massive Loss &#8805;US $1M')"><span style="color:white;font-weight:normal;font-size:9px;font-family:Sans serif;">Massive Loss &#8805;US $1M</span>
    </td>
...
<table id="splashtable" border="0" cellspacing="0" cellpadding="4" bgcolor="<%= tablebordercolor %>" width="<%= cint(cellwidth) * 5 +1 %>" style="position:absolute;left:443px;top:215px;">
...
<p></p>
        ...
        <table cellSpacing="0" cellPadding="0" width="100%" border="0" bgcolor="white">
          ...
          <tr>
          <td align="center">
            <input type="submit" value="Submit" style="font-size:10px;width:160px;margin-top:5px;margin-left:0px;margin-bottom:3px;">
            <input type="button" value="Return To Stage Input" style="font-size:10px;width:160px;margin-top:5px;margin-left:0px;margin-bottom:3px;" onclick="document.location='divisional_StageInput.asp?log_number=<%= log_number %>&viewDivision=<%= viewDivision %>'">
            <br />
            <input type="button" value="Return To Stage List" style="font-size:10px;width:160px;margin-top:1px;margin-left:0px;" onclick="document.location='divisional_StageList.asp?viewDivision=<%= viewDivision %>'">
          </td>
        </tr>
        <tr height="50">
          <td>
