...
view_division = request("viewdivision")

%>
<table border="0" cellpadding="0" cellspacing="0" width="100%;">
	<tr>
		<td align="center">
<h3>Bristow Full Report<br>
<% if(base <> "") then %>
Base <%= base %>
<% end if %>
&nbsp;::&nbsp;
...
if(base <> "") then
  sql = "select lognumber from EHD_Data where active = 'y' and formname = 'iSRT_LogInput' and division = "& sqltext2(view_division) &" and base = "& sqltext2(base) &" order by lognumber asc"
end if
if((aircraft <> "") and (aircraft <> "All")) then
  sql = "select lognumber from EHD_Data where active = 'y' and formname = 'iSRT_LogInput' and division = "& sqltext2(view_division) &" and equipment = "& sqltext2(aircraft) &" order by lognumber asc"
end if
...
if((item_status = "Closed ALARP") or (item_status = "Closed")) then
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= transFlag(generic) %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Comments :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= item_comments %></span></td>
</tr>
<% if(base <> "") then %>
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= mission %></span></td>
</tr>
<% end if %>
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= transSOI(soi) %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Endorsed :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= transFlag(endorsed) %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
...
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">POC :</span></td>
...
<tr valign="top" style="padding-top:7px;">
  ...
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= safety_action_open %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Due :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= safety_action_due %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Completed :</span></td>
  <td width="<%= cell2width %>"><span style="font-weight:normal;"><%= safety_action_completed %></span></td>
</tr>
<tr valign="top" style="padding-top:7px;">
  <td width="<%= cell1width %>" align="right" style="padding-right:5px;"><span style="font-weight:normal;">Status :</span></td>
