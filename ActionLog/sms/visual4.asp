...
<div style="background-color:#ffffff;width:870px;">
<br>
<div align="center">
<span style="padding-bottom:18px;padding-left:30px;color:black;font-weight:bold;font-size:12px;">RISK ASSESSMENT MATRIX</span>
<br><br>
<table border="0" cellspacing="1" cellpadding="4" bgcolor="black" width="<%= tablewidth %>">
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= headerheight %>">
    <td rowspan="2" align="center"><span style="color:black;font-weight:bold;">&nbsp;</span>
    </td>
    <td colspan="6" align="center"><span style="color:black;font-weight:bold;">SEVERITY LEVELS</span>
    </td>
    <td colspan="5" align="center"><span style="color:black;font-weight:bold;">LIKELIHOOD LEVELS</span>
    </td>
  </tr>
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= headerheight %>">
    <td colspan="2" align="center"><span style="color:black;font-weight:bold;">PEOPLE</span>
    </td>
    <td align="center"><span style="color:black;font-weight:bold;">PLANET</span>
    </td>
    <td colspan="3" align="center"><span style="color:black;font-weight:bold;">PROFIT</span>
    </td>
    <td align="center"><span style="color:black;font-weight:bold;">A</span>
    </td>
    <td align="center"><span style="color:black;font-weight:bold;">B</span>
    </td>
    <td align="center"><span style="color:black;font-weight:bold;">C</span>
    </td>
    <td align="center"><span style="color:black;font-weight:bold;">D</span>
    </td>
    <td align="center"><span style="color:black;font-weight:bold;">E</span>
    </td>
  </tr>
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= labelheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">RATING</span>
    </td>
    <td width="<%= cellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">PHYSICAL INJURY</span>
    </td>
    <td width="<%= cellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">SECURITY THREAT</span>
    </td>
    <td width="<%= cellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">DAMAGE TO THE ENVIRONMENT</span>
    </td>
    <td width="<%= cellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">DAMAGE TO ASSETS</span>
    </td>
    <td width="<%= cellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">POTENTIAL INCREASED COST OR REVENUE LOSS</span>
    </td>
    <td width="<%= cellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">DAMAGE TO CORPORATE REPUTATION</span>
    </td>
    <td id="CELL_A_A" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Unknown But Possible In The Aviation Industry')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">UNKNOWN BUT POSSIBLE IN THE INDUSTRY</span>
    </td>
    <td id="CELL_B_B" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Known In The Avaition Industry')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">KNOWN IN THE INDUSTRY</span>
    </td>
    <td id="CELL_C_C" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Occurred In The Company')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">OCCURRED IN THE COMPANY</span>
    </td>
    <td id="CELL_D_D" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Reported &gt;3x/Yr Within The Company')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">REPORTED MORE THAN THREE TIMES PER YEAR WITHIN THE COMPANY</span>
    </td>
    <td id="CELL_E_E" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Reported &gt;3x/Yr At A Particular Location')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">REPORTED MORE THAN THREE TIMES PER YEAR AT A PARTICULAR LOCATION</span>
    </td>
  </tr>
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">0</span>
    </td>
    <td id="CELL_0_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Injury')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">No Injury</span>
    </td>
    <td id="CELL_0_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Effect')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">No Threat To Personnel</span>
    </td>
    <td id="CELL_0_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Damage')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">No Effect</span>
    </td>
    <td id="CELL_0_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Increased Cost or Lost Revenue')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">No Damage</span>
    </td>
    <td id="CELL_0_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">No Increased Cost Or Loss Revenue</span>
    </td>
    <td id="CELL_0_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'No Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">No Implication</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">1</span>
    </td>
    <td id="CELL_1_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Injury')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Minor Injury</span>
    </td>
    <td id="CELL_1_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Effect')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Unlikely Threat To Personnel</span>
    </td>
    <td id="CELL_1_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Damage &lt;US $50K')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Minor Effect</span>
    </td>
    <td id="CELL_1_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Loss &lt;US $50K')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Minor Damage (Less Than $100,000)</span>
    </td>
    <td id="CELL_1_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Limited Localized Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Minor Loss (Less Than $100,000)</span>
    </td>
    <td id="CELL_1_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Limited Localized Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Limited Localized Implication</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">2</span>
    </td>
    <td id="CELL_2_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Serious Injury')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Multiple Minor Injuries</span>
    </td>
    <td id="CELL_2_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Contained Effect')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Possible Threat To Personnel</span>
    </td>
    <td id="CELL_2_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Substantial Damage &lt;US $250K')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Contained Effect</span>
    </td>
    <td id="CELL_2_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Substantial Loss &lt;US $250K')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Substantial Damage (From $100,000 To Less Than $250,000)</span>
    </td>
    <td id="CELL_2_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Regional Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Substantial Loss (From $100,000 To Less Than $1 Million)</span>
    </td>
    <td id="CELL_2_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Regional Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">National Implication</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">3</span>
    </td>
    <td id="CELL_3_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Single Fatality')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Serious Injury</span>
    </td>
    <td id="CELL_3_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Minor Effect')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Probable Threat To Personnel</span>
    </td>
    <td id="CELL_3_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Major Damage &lt;US $1M')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Major Effect</span>
    </td>
    <td id="CELL_3_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Major Loss &lt;US $1M')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Major Damage (From $250,000 To Less Than $1 Million)</span>
    </td>
    <td id="CELL_3_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'National Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Major Loss (From $1 Million To Less Than $10 Million)</span>
    </td>
    <td id="CELL_3_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'National Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Regional Implication</span>
    </td>
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="bottom">
    <td width="<%= firstcellwidth %>"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">4</span>
    </td>
    <td id="CELL_4_1" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Multiple Fatalities')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">One Or More Fatalities</span>
    </td>
    <td id="CELL_4_2" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Massive Effect')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Imminent Threat To Personnel</span>
    </td>
    <td id="CELL_4_3" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Catastrophic Damage &ge;US $1M')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Massive Effect</span>
    </td>
    <td id="CELL_4_4" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'Massive Loss &ge;US $1M')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Catastropic Damage ($1 Million Or Greater)</span>
    </td>
    <td id="CELL_4_5" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'International Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">Catastrophic Loss ($10 Million Or Greater)</span>
    </td>
    <td id="CELL_4_6" width="<%= cellwidth %>" onmouseover="mouseovercell(this)" onmouseout="mouseoutcell(this)" onclick="cellclicked(this,'International Implication')"><span style="color:black;font-weight:bold;font-size:9px;font-family:Sans serif;">International Implication</span>
    </td>
...
<br>
<div style="padding-left:30px;"><span id="ACCEPTABILITY_SPAN" style="padding-bottom:18px;color:black;font-weight:bold;font-size:18px;">&nbsp;</span></div>
<br><br>
</div>
...
<table id="splashtable" border="0" cellspacing="0" cellpadding="4" bgcolor="<%= tablebordercolor %>" width="<%= cint(cellwidth) * 5 +1 %>" style="position:absolute;left:454px;top:240px;display:none;">
  ...
  <tr bgcolor="<%= cellbackgroundcolor %>" height="<%= cellheight %>" align="center" valign="top">
    ...
    <td colspan="2" style="background-color:green;"><span style="padding-left:30px;color:black;font-weight:bold;font-size:10px;">Acceptable</span>
    </td>
    <td width="<%= cellwidth %>" style="background-color:green;">
    </td>
    <td width="<%= cellwidth  %>" style="background-color:green;">
