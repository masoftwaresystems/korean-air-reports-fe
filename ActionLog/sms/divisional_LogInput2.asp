...
<!--
    <tr>
        ...
        <td>
               <select id="division" name="division" style="width:440px;" class="textbox">
<%= divisionOpts %>
                </select><script>document.getElementById("division").value = "<%= division %>";</script>
        </td>
    </tr>
-->
    <tr>
...
<!--
        <div>
               <select id="station" name="station" style="width:423px;" class="textbox">
<%= stationOpts %>
                </select><script>document.getElementById("station").value = "<%= station %>";</script>
        </div>
-->
        </td>
    </tr>
...
frm.item_status.value = "<%= item_status %>";
    ...
    <tr>
        ...
        <td>
<select id="endorsed_by" name="endorsed_by" style="width:130px;" class="textbox">
  <option value=""></option>
