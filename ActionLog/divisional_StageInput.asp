...
function goToRisk() {
  frm.action = "divisional_stagevisual.asp";
  frm.submit();
  //checkRequired();
}
...
function viewAssessmentSummary() {
  frm.action = "divisional_submitRiskanalysis.asp";
  //frm.submit();
  checkRequired();
}
...
<form action="divisional_saveStageData.asp" method="post" name="frm" id="frm">
...
<input type="hidden" id="resultPage" name="resultPage" value="divisional_StageList.asp">
...
<input type="submit" value="Save" style="font-size:10px;width:160px;font-weight:normal;height:20px;margin-right:3px;"><input type="button" value="Assess Risk" style="font-size:10px;width:160px;font-weight:normal;height:20px;" onclick="goToRisk()"><br><input type="button" value="Return To Stage List" style="font-size:10px;width:160px;font-weight:normal;height:20px;margin-top:3px;margin-right:3px;" onclick="document.location='divisional_stageList.asp?viewdivision=<%= viewdivision %>'"><% if(request("log_number") <> "") then %><% if(session("srt_admin") = "w") then %><input type="button" value="Add to Divisional Action Log" style="font-size:10px;width:160;font-weight:normal;height:20px;margin-top:3px;margin-bottom:0px;" onclick="sendPromotionRequest()"><% end if %><% if((session("srt_admin") = "y") or (session("srt_admin") = "l") or (session("srt_admin") = "p")) then %><input type="button" value="Add to Divisional Action Log" style="font-size:10px;width:160px;font-weight:normal;height:20px;margin-top:3px;margin-bottom:0px;" onclick="promoteToDivisional()">
<% end if %>
<% end if %>
<br>
...
function promoteToDivisional() {
  document.frm.action = "promoteToDivisional.asp";
  document.frm.submit();
}
