...
<!--#include file="includes/logged_in_user.inc"-->
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="http://www.masoftwaresystems.us/miat/splash.aspx">Action Log</a> <div class="breadcrumb_divider"></div> <a class="current">Reports :: All Hazards</a></article>
		</div>
...
<h3>All Hazards</h3>
   ...
   //alert(v);
     if(v == "internal") {
       document.frm.action = "customReport.asp";
     } else {
       document.frm.action = "customerReport.asp";
     }
   }
   </script>
...
<!--
<table border="0" cellspacing="0" cellpadding="0" width="550" style="padding-top:5px;margin-left:10px;">
  <tr><td align="center"><select class="fonts1" style="width:210px;font-size:13px;"  onchange="changeAction(this.value)"><option value="internal" selected>Internal Report Type</option><option value="external" >Customer Report Type</option></select></td></tr>
</table>
-->
<form name="frm" action="customReport.asp" method="get" target="_blank">
<table border="0" cellspacing="0" cellpadding="0" width="550" style="padding-top:5px;margin-left:10px;">
