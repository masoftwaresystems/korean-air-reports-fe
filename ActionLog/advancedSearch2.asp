...
<!--#include file="includes/logged_in_user.inc"-->
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="http://www.masoftwaresystems.us/miat/splash.aspx">Action Log</a> <div class="breadcrumb_divider"></div> <a class="current">Advanced Search</a></article>
		</div>
...
<form action="divisional_LogDisplay.aspx" method="post" name="frm" id="frm" >
