...
<div style="margin-right:0px;margin-left:0px;">
  <table border="0" cellspacing="0" cellpadding="0" width="100%" style="padding-top:3px;margin-left:0px;margin-right:10px;">
    <tr valign="bottom">
      ...
      <td style="" align="center" width="33%" style="font-size:15px;font-weight:bold;padding-bottom:5px;font-color:#000040;" background="" bgColor="#ffffff">Global Operations Action Log</td>
...
<table style="background-color:#FFFFFF
  ...
  <tr>
    <td colspan="2" height="30" align="center"><div class="title" style="background:#737579;color:white;padding-bottom:2px;">Safety Management Action Log (SMAL)<br>Login</div></td>
  </tr>
  <tr>
